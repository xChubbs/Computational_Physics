...
program main
  ...
  real(8) :: x_left = -2.                           ! Definition of far limits: Inifinity for the aproximation
  ...
  x_right = (/ 3., 3., 4., 6., 8., 15. /)

  delta = (/ 1.d-12, 1.d-13, 1.d-13, 1.d-13, 1.d-13, 1.d-13 /) ! Maximum error admitted per energy


  Psi_condition = (/ 1.d-12, 0.d0 /)                      ! Even conditions: Near zero conditions
  ...
  open(UNIT = 1, FILE = 'psi_values.txt', STATUS = 'UNKNOWN')
  ...
  open(UNIT = 2, FILE = 'epsilon_values.txt', STATUS = 'UNKNOWN')
